...
<head>
    ...
    <script>
        function Welcome() {
            <?php
            if (!isset($_SESSION["firstLogin"]) && !isset($_POST["乘法"])) {
            ...
            document.addForm.乘法.focus();
        }

        function check() {
            var 乘法 = document.addForm.乘法.value;
            if (乘法.length == 0) {
                alert('注意:\n\n請提供作答內容!');
                document.addForm.乘法.focus();
                return false;
                        ...
                        <?php
                            if(isset($_POST["乘法"]))
                            {
                                ...
                                if($mult==$mult1)
                                {
                                    ...
                                    echo '<br><input class="btn btn-info type="button" value="下一題" onclick="document.location.href=\'mathx.php\';">';
                                    echo "<script>
